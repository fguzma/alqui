...
@section('script')
    ...
    <script>
        ...
        function filtro(val1=0,val2=0)
        {
            ...
            var ruta="https://alqui.herokuapp.com/filtroinventario/"+servi+'/'+item;
            console.log(ruta);
            var token=$("#token").val();
        ...
        function actualizar()
        {
            route="https://alqui.herokuapp.com/inventario/"+$("#id").val();
            var token=$("#token").val();
            $.ajax({
                url: route,
        ...
        $('.delete').on( 'click', function () {
            ...
            var route="https://alqui.herokuapp.com/inventario/"+$(this).val();
            var token=$("#token").val();
            $.ajax({
                url: route,
                headers:{'X-CSRF-TOKEN': token},
