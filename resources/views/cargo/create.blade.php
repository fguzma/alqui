...
@section("script")
  ...
  //ejemplo: agregar persona1 con cargo x,y. persona2 con cargo x,y pero persona 3 con cargo a,b al mismo tiempo.
    ...
    function guardar()
    {
      ...
      var ruta = "http://127.0.0.1:8080/cargosave";
      var token = $("#token").val();
      console.log("entra");
      $.ajax({
        url: ruta,
    ...
    function guardarcargo(decision)
    {
      ...
      /*HACER FUNCIONAR ESTO*/
      var ruta = "http://127.0.0.1:8080/cargo";
      var token = $("#token").val();
      $("#msjlista").empty();
      console.log("entra");
      $.ajax({
        ...
        success: function(result){
          ...
          {
            location.href="http://127.0.0.1:8080/cargov/1/"+$("#Nom").val();
          }
          return;
        }
      }).fail( function( jqXHR, textStatus, errorThrown ) {
    ...
    {
      ruta="http://127.0.0.1:8080/listacargo";
